...
function ph_google_footer_script() {
?>
...
function ph_facebook_footer_script() {
?>
<div id="fb-root"></div>
...
function ph_social_media_counters_display( $choice, $link, $title ) {
		...
		$phsmc .= '<div class="phsmc phsmc_thin_twitter" id="phsmc_'.$choice.'_twitter">';
		...
		$phsmc .= '<div class="g-plusone" data-size="medium" data-href="'.$encoded_link.'"></div>';
		$phsmc .= '';
		$phsmc .= '</div>';
		}		
		...
		if(get_option('ph_social_counter_'.$choice.'_service_facebook') == "on") {
		$phsmc .= '<div class="phsmc" id="phsmc_'.$choice.'_facebook">';
		$phsmc .= '<div class="fb-like" data-href="'.$encoded_link.'" data-send="false" data-layout="box_count" data-show-faces="true"></div>';
 		$phsmc .= '</div>';
		}
...
add_action('wp_footer', 'ph_facebook_footer_script');
add_action('wp_footer', 'ph_google_footer_script');

function ph_social_counter_style() {
	$css_url = plugins_url('/style.css' , __FILE__);
	$css_file = plugins_url('/style.css' , __FILE__);
	// if ( file_exists($css_file) ) {
		wp_register_style('social-media-counters', $css_url);
		wp_enqueue_style('social-media-counters');
	// }
}
