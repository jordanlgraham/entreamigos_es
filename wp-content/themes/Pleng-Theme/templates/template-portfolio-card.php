...
?>	
						...
						?>
											...
											?>
														<div class="card_grid_shadow">
															<div class="card_portfolio_grid <?php echo $last_class; ?>">
																<a href="<?php echo $permalink_url; ?>">
																	<img src="<?php bloginfo( 'stylesheet_directory' ); ?>/timthumb.php?src=<?php echo $image_url[0]?>&amp;h=286&amp;w=196&amp;zc=1" alt=""/>
																</a>																																	<p>
