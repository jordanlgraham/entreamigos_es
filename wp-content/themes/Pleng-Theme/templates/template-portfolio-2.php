						...
						?>
											...
											?>
															<div class="one_half<?php echo $last_class?>">
																<div class="portfolio_image img_shadow_360">
																	<img src="<?php bloginfo( 'stylesheet_directory' ); ?>/timthumb.php?src=<?php echo $image_url[0]?>&h=290&w=400&zc=1" alt="" class="frame"/>
																	
																	<span class="portfolio2_hover">
