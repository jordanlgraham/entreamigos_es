						...
						<ul id="kwicks_slider">
							...
							<div>
								...
								<a href="<?php echo $hyperlink_url;?>">
									<img src="<?php bloginfo( 'stylesheet_directory' ); ?>/timthumb.php?src=<?php echo $image_url[0]; ?>&amp;h=380&amp;w=900&amp;zc=1" alt="" <?php if(!empty($caption_style)) { echo 'title="'.$caption_style.'"'; } ?> style="display:block"/>
								</a>
								<div class="kwicks_title" style="display:block">
									<h6 class="cufon"><?php echo $gallery_item->post_title; ?></h6>
								</div>
